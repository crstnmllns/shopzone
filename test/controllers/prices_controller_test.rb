...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { pricecost: @price.pricecost, product_id: @price.product_id, salesprice: @price.salesprice } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { pricecost: @price.pricecost, product_id: @price.product_id, salesprice: @price.salesprice } }
